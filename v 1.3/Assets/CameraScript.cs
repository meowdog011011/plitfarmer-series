...
public class CameraScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            speed = 0.01f + ((GameScript.level - 9) * 0.005f);
        }
        else
        {
            speed = 0.01f;
    ...
    void Update()
    {
        ...
        else if (gameScript.stage == 3)
        {
            ...
            {
                camera.backgroundColor = new Color32((byte)UnityEngine.Random.Range(0, 256), (byte)UnityEngine.Random.Range(0, 256), (byte)UnityEngine.Random.Range(0, 256), 255);
                colorChangeTimer = 0;
            }
        }
